...
char STR_FORMAT[] =  "%-20s %10s %10s %10s %10s %10s %10s\n";
char DATA_FORMAT[] = "%-20s %10ld %10d %10ld %10ld %10ld %10.2f\n";
...
void fincore(char* path, 
    ...
    total_pages = (int)( (double)file_stat.st_size / (double)page_size );
